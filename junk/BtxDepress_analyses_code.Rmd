---
title: Data analysis for 'Does blocking facial feedback via botulinum toxin
  injections decrease depression? A critical review and meta-analysis'
...
---
This script preps and performs statistical analyses for a meta-analysis of studies examining the impact of glabellar-region botulinum toxin injections on depression.
...
packages <- c('metafor', 'dplyr', 'readxl',
              'weightr', 'MAd', 'robumeta', 'ggplot2',
              'knitr', 'gtools', 'kableExtra')
ipak(packages)
rm(packages, ipak)
...
# write function for converting p-values to symbols
# code adapted from gtools package
AbbrvPval <- function (p.value){
    unclass(symnum(p.value, 
                   corr = FALSE, 
                   na = FALSE, 
                   cutpoints = c(0, 0.001, 0.01, 0.05, 0.1, 1), 
                   symbols = c("< .001", "< .01", "< .05", "< .10", "> .10")))
}
```
