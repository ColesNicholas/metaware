...
# calculate mot, opp, bel, and pre scores. Then delete vestigial
DF <- DF %>% 
  rowwise() %>% 
  
  # calculate scores, 
  # summing in instances where there are two demand conditions--i.e., !is.na(v2.mot)
  mutate(mot = 
         ...
         opp = 
           if_else(condition = is.na(v2.opp),
                   true = v1.opp,
                   false = v1.opp + v2.opp),
