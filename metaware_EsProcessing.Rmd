...
---
This code take processes the raw data contained in "metaware_data_raw.xlsx"
...
ML
Need to add this formula first: https://raw.githubusercontent.com/MathiasHarrer/dmetar/master/R/mlm.variance.distribution.R
```{r}
DF$es.id <- 1 : nrow(DF)
