...
authornote: |
  Public significance statement: A fundamental methodological concern in research with human participants is that their responses are biased by their beliefs about the researcher’s hypothesis (i.e., demand characteristics). In a meta-analysis, we combined evidence from 40 studies that experimentally tested this concern by manipulating the hypothesis communicated to participants. Results suggested that information about the researcher’s hypothesis can produce biases in participants’ responses that can be potentially large – but are troublingly unreliable and difficult to explain.
