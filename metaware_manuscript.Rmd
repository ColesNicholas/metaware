...
Note to Nick: the results basically flip depending on whether you use fixed- or random-effects meta.

I think it's because of how those small studies are being weighed?

rma.uni(yi = yi, 
        vi = vi,
        data = DF.agg,
        mods = ~ se,
        method = "FE") # switch to RE to see phenom
```{r}
...
# Note: can use non-aggregated data
##########################
sens <- corrected_meta(yi = DF.es$es,
                       vi = DF.es$es.var,
                       eta = 49,
