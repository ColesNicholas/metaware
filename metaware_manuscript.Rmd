---
title             : "What have we learned about demand characteristics? A meta-analytic review of experimental manipulation of explicit hypothesis cues"
...
rbind(
  ...
  cbind(
    ...
    k = DF.es[DF.es$student == 'yes',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$student$sub$b[[3]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$student == 'no',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$student$sub$b[[2]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$student == 'mix',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$student$sub$b[[1]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$online == 'yes',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$online$sub$b[[2]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$online == 'no',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$online$sub$b[[1]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$design == 'within',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$design$sub$b[[2]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$design == 'between',]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$design$sub$b[[1]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    s = DF.es[DF.es$ref.type == 'cvp', ]$id.study %>%
      unique() %>%
      length(),
    k = DF.es[DF.es$design == 'cvp', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$ref.type.full$sub$b[[1]] %>% round(2),
    B1 = "--",
    ...
    p = mod.r$ref.type.full$sub$pval[[1]]
  ),
  ...
  cbind(
    ...
    s = DF.es[DF.es$ref.type == 'cvz', ]$id.study %>%
      unique() %>%
      length(),
    k = DF.es[DF.es$design == 'cvz', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$ref.type.full$sub$b[[2]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$design == 'nvc', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$ref.type.full$sub$b[[3]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$design == 'pvz', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$ref.type.full$sub$b[[5]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$design == 'pvn', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$ref.type.full$sub$b[[4]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$published == 'yes', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$published$sub$b[[2]] %>% round(2),
    B1 = "--",
  ...
  cbind(
    ...
    k = DF.es[DF.es$published == 'no', ]$id.es %>%
      unique() %>%
      length(),
    d = mod.r$published$sub$b[[1]] %>% round(2),
    B1 = "--",
