...
We used standardized mean difference scores as our effect size index [Cohen's $d_{s}$ and $d_{rm}$; @borenstein2009effect; @cohen1988statistical).
...
## Rater forecasts of demand effects (left off here)
