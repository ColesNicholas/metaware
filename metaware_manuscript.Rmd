...
All materials, data, and code are openly available at <https://osf.io/3hkre/>. This link also contains analysis pre-registration plan, as well as documented amendments. All code (including the script used to generate a computationally-reproducible manuscript) has been checked for reproducibility.
...
### Transparency and openness
All materials, data, and code are openly available at <https://osf.io/3hkre/>. This link also contains analysis pre-registration plan, as well as documented amendments. All code has been checked for reproducibility.
...
### Transparency and openness
All materials (including exploratory items not described in the manuscript), data, and code are openly available at <https://osf.io/3hkre/>. Because the study was exploratory, there was no pre-registration. All code has been checked for reproducibility.
