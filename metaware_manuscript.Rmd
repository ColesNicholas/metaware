...
# Note to Nick: there is incomplete data. But I guess we still include them?

# identify number of participants who completed the survey
survey.DF <- read.csv("data/metaware_SurvData_raw.csv") #%>% 
  # select demographic variables
  #select(indiv_gend_var, indiv_agee_var, ethnicity)

# remove rows containing unnecessary variable details
survey.DF <- survey.DF[-(1 : 2), ]

survey.DF <- survey.DF %>% arrange(as.numeric(Progress))

tmp <- read.csv("data/metaware_survey2_clean.csv")
