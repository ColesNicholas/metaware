...
`r survey.n` undergraduates from Stanford University reviewed 10 randomly-selected vignettes in exchange for course credit. For each vignette, raters were asked to first identify the researcher's hypothesis. Here, participants chose between four options that described a filler effect (usually involving a different dependent variable) or a positive, negative, or nil effect of the independent variable on the dependent variable. Afterwards, they rated the extent to which they would (1) be motivated to provide hypothesis-consistent responses (-3 = "extremely motivated to adjust responses to be inconsistent" to 3 = "extremely motivated to adjust responses to be consistent"), (2) be able to adjust their responses on the outcome-of-interest (0 = "extremely incapable" to 4 = "extremely capable), and (3) believe the experimenter's hypothesis (-3 ="strong disbelief" to 3 = "strong belief"). Raters also indicated whether they believed participants would confirm the hypothesis, which we discuss later. These questions were presented in random order.
...
First, it is possible that raters did not have enough information to make an accurate prediction about participants' motivation, opportunity to adjust responses, and belief in the experimenter's communicated hypothesis. For the sake of feasibility, we gave participants a short summary of the study set-up and hypothesis communicated by the researcher. However, it is not clear if participants could accurately imagine the reality of being in these studies based on their relatively short descriptions. Indeed, when trying to gauge the impact of demand characteristics, @orne1969demand often would provide participants with extensive information about the study---perhaps even by running them through some of the procedures. It is thus possible that raters would have provided more valid ratings if more information was provided (e.g., video recordings of recreations of the study).
...
Third, like in most meta-analysis, it is possible that our moderator analyses were underpowered and/or contained unidentified confounds. To address these three limitations, we re-examined the moderators in a small replication of an experiment in the demand characteristics literature.
...
A comprehensive examination of strict experimental manipulations of demand characteristics reveal that they typically lead to a small shift in participants' responses that is in the direction of the communicated hypothesis. These effects, however, are extremely heterogeneous. Using admittedly arbitrary thresholds, we estimated that `r h.c` % of demand characteristics manipulations produce hypothesis-consistent shifts in participants' responses ($d$ \> 0.10). `r h.i` % produce hypothesis-*in*consistent shifts in participants' responses ($d$ \< -0.10), and `r 1 - h.c - h.i` % produce negligible shifts in either direction (-0.10 \< $d$ \> 0.10).

Most worrisome, the estimated distribution of demand effects suggests that they can range from approximately $d$ = -1.00 to $d$ = 1.00. Virtually every documented effect in experimental psychology falls within this range. Thus, to distinguish the theoretical effects that psychologists want to estimate from the artifactual demand effects they do not, an understanding of how demand characteristics impact responses---and how these effects can be avoided---is crucial.

Thus far, an examination of all available evidence provides a clue about how demand characteristics bias participant responses. Contrary to virtually every existing proposed theoretical framework (e.g., @rosnow1997people and @coles2022fact), we did not find evidence that demand effects are driven by response bias. More specifically, we did not find that two moderators theorized to underlie response biases---motivation and opportunity to adjust responses---moderated the effects of experimentally-manipulated demand characteristics. Instead, our results are consistent with a more parsimonious view: that these effects are driven by participants' beliefs. In other words, despite attempts to distinguish their construct from conceptually-related work on placebo, it is possible that demand characteristic theorists simply rediscovered a form of placebo effects.

## Implications for conceptualizations of participant roles

In his pioneering work on demand characteristics, @orne1962social characterized participants as "good subjects" who are motivated to help the researcher confirm their hypothesis. Our results do not support such a characterization. Indeed, across all experimental contexts reviewed by Study1b participants, the estimated mean motivation to help confirm the study hypothesis was near zero (*M* =, *SD* = ). To be sure, there were some study contexts in which participants reported slight motivation to confirm the experimenter's hypothesis, such as when they were told the researcher expected them to (a) prefer a news article that favors their political party (*M* = ), (b) avoid perceiving a shift in an optical illusion (*M* =), and (c) feel moved by happy and sad music (*M*). However, this can alternatively be interpreted as motivation to respond in a manner that is consistent with their beliefs---not help the experimenter. Indeed, participants were generally only motivated to confirm the hypothesis when it conformed with their own beliefs, as evidenced by a modest-sized correlation between the two ($r$ = ). These results are consistent with a lesser-known proposal by @fillenbaun1970more, who argued that participants are "faithful subjects" who are motivated to respond in a way they perceive as natural.

The faithful subject conceptualization---in retrospect---can accommodate findings from many classic studies that seemingly demonstrated participants' motivation to help the experimenter or secure positive evaluations. For instance, when participants exhibited sham symptoms of hypnosis, @orne1962social concluded that the participants did so to please the experimenter. However, an alternative explanation is that these were faithful subjects who were merely acting in accordance with their beliefs. Similarly, when participants reduced performance on a simple task after being told that high performance was indicative of an obsessive-compulsive personality, @sigall1970cooperative concluded that participants did so to secure a positive evaluation. Once again, an alternative explanation is that these participants believed they did not possess a personality disorder and handled themselves accordingly.
...
In the Figure X causal graph, we present an experimental context confounded by demand characteristics. For example, we assume that the experimental manipulation---here, asking participants to pose happy and neutral expressions---impacts participants' mood through a psychologically-interesting mechanism (e.g., by activating other emotion-related physiological responses, like increases in heart rate). We further assume that these changes in mood are subsequently reported in the dependent variable, which here is a self-report measure of mood. We assume that facial poses do indeed activate pre-existing beliefs about their effects, which can lead to naturalistic placebo effects on mood (Coles citation). More importantly, though, we add that the experimental task can readily lead participants to infer that the experimenter expects smiling to increase mood---i.e., there are demand characteristics. We suggest that this information can shape participants' beliefs about the impact of the task, which can further exacerbate placebo-induced changes in mood.

by asking participants to pose happy and neutral expressions (IV), researchers may inadvertently signal that they believe doing so will impact mood. We assume

Ultimately, these questions will require researchers to develop, test, and refine a more sophisticated theory of demand characteristics.

we might wish

we might ask ourselves to reflect on the ways our experimental contexts

is the wrong question because it focuses
