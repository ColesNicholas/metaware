...
tmp.m.3 <- ModAnalysis(m = "mot.c * opp.c",
            df = tmp %>% 
               filter(ref.type != "cvz" &
                        ref.type != "pvz"))
