...
```{r modfig, fig.cap= "The effects of demand characteristics on participants' responses were not significantly associated with motivation (Panel A), opportunity (Panel B), or prediction (Panel D) ratings. They were, however, significantly associated with belief  ratings (Panel C).", fig.height = 4.5, fig.width = 6.5}
#################
# motivation plot
#################
