...
```{r mod.sens, eval = F}
# A reviewer pointed out that some people might argue that we should not have combined within and between subject designs. You can run this code and change the type argument to explore this issue.

# create moderator analysis function
ModSens = function(m, type = "within",
                   df = DF.es) {
...
# conduct moderator and subgroup analyses for moderators assessed with full dataset 
mod.l <- c("student", "paid", "online", "ref.r", "published",
           "year", "att",
...
## combine results
mod.r.sens = c(mod.r.sens, mod.r.sens.2)
...
In his seminal writings, Orne [-@orne1962social] argued that "...all experiments will have demand characteristics, and these will always have some effects" (p. 779). We attempted to take stock of what we have learned in the 50+ years since by synthesizing `r overall$k` effect sizes from `r overall$n` studies that explicitly manipulated cues about the study hypothesis. Our results suggest that the effects of such cues are inferentially consequential, unreliable, difficult to predict, and challenging to explain.

Should our observations undermine confidence in the utility of experimental psychology? This, we believe, is a question that demands more attention.
