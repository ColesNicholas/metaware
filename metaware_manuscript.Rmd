...
If this scenario were real, you would reasonably question whether Colesology is a valid method of scientific inquiry. However, perhaps we should not be so quick to judge. Because, like the Colesologist, experimental psychologists deal with a difficult-to-understand methodological artifact: *demand characteristics*.
...
After over 60 years, experimental psychologists are left with an uncomfortable state of affairs. Demand characteristics are a literal textbook methodological concern. However, like the Colesologist, it is not clear when, how, and in what direction the effect of this artifact emerges.
...
In Study 2, we review a small replication study that re-examines the the extent to which demand characteristic effects can be explained by response biases and placebo effects. In this replication study, we manipulated demand characteristics in the context of an experiment examining the effects of facial poses on self-reported emotion (i.e., facial feedback). We then examined whether the effect of demand characteristics could be explained by factors believed to underlie response biases (i.e., self-reported motivation and opportunity to adjust responses), and placebo effects (i.e., self-reported belief in the communicated hypothesis).

We end the paper with discussion of the steps we believe are required to transform vague frameworks about demand characteristics into formal theories---theories we believe might help distinguish a valid experimental psychology from the invalid methods of Colesology.

# Study 1a

Study 1a was designed to provide the first quantitative synthesis of strict experimental tests of demand effects, with a focus on the the direction, magnitude, and consistency of the effect.
...
Overall, explicit manipulations of demand characteristics lead to a small but highly heterogeneous acquiescence effect.

Significant counteraqcquiesence effects were rarely observed in the studies in our sample. However, if we assume that our meta-analysis accurately estimated the true mean and standard deviation of a normal distribution of demand effects, 23% of these effects theoretically fall below zero. In other words, participants are three times more likely to acquiesence than counteracquiesence.

What factors lead to stronger acquiesence effects?

-   Working with students

-   Telling participants you expect *no* effect to emerge

-   Possibly paying participants

Study 1 gives us some information about the consistency and situational moderators of demand effects. However, they do not address outstanding questions regarding the extent to which these  effects are driven by response bias vs. placebo effect. Students may be more likely to be motivated to help the experimenter (response bias), but they may also be more likely to believe the communicated hypothesis (placebo effect). Participants may be more motivated to exhibit no change in response (response bias); but it's also possible that telling participants that we expect *no* effect causes a more drastic shift in beliefs than communicating an expectation for a positive or negative effect (placebo effect).

The purpose of Study 1b is to figure our why these effects are occuring.
