...
```{r funnel, fig.cap = "Funnel plot of non-aggregated and aggregated effect sizes.", eval = F}
...
[] Add markdown for study 3

[] Add forest plot

[] Need to streamline publication bias analysis figure (or just drop completely)
