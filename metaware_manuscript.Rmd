...
Figure (\@ref(fig:prisma)) summarizes our literature search and screening, which was initially developed in consultation with a librarian at (anonymous for peer review) and then later expanded based on reviewer feedback.
...
Figure (\@ref(fig:prisma)) more thoroughly summarizes exclusion criteria. Coderes were asked to choose only one option in instances where many criteria applied.
