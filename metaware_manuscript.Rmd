...
As this brief review shows, demand characteristics are uncomfortably close to the mysterious methodological artifact described in the opening of the paper. Demand effects are a literal textbook methodological concern in experimental psychology [@sharpe2016frightened], but their magnitude, direction, and consistency remain unclear. In the present paper, we use meta-analysis to take stock of what we have learned -- if anything -- about demand effects. We begin by briefly reviewing one of the most comprehensive and influential framework describing their effects.

## How do demand characteristics alter participant responses?

Historically, there has been little agreement about how demand characteristics alter participant responses. A detailed review of such disagreements is outside the scope of our quantitative review [see @corneille2022sixty]. Instead, we focus on one of the most comprehensive and influential frameworks describing their effects [@rosnow1997people].

## Rosnow and Rosenthal (1997)

In a book dedicated to methodological artifacts, @rosnow1997people articulated one of the most influential frameworks for conceptualizing demand effects [see also @rosnow1973mediation; @strohmetz2008research]. In this framework, they unified decades of previous theorizing by positing that demand effects had three key moderators: (1) receptivity to cues, (2) motivation to provide hypothesis-consistent responses, and (3) opportunity to alter responses.

To start, @rosnow1997people reasoned that participants must be receptive to demand characteristics for there to be subsequent shifts in participants' responses. As an extreme example, imagine that a researcher hands an infant a sheet of paper that precisely explains the study hypothesis. Demand characteristics are certainly present, but they are not predicted to have an impact because the infant is not receptive to the cues. Even if the infant possessed the astonishing ability to read, it's possible they would misinterpret the cues -- which may be considered another form of non-receptivity [@corneille2022sixty]. We mention this receptivity moderator for the sake of comprehensiveness, but will not discuss it further.
...
### Vignette ratings of potential psychological moderators

During our literature review, we found very few papers that attempted to quantify or test the moderators described by @rosnow1997people. @orne1969demand suggested that participants themselves may be particularly adept at predicting demand effects. Thus, we sought to estimate the mean values of @rosnow1997people's moderators from naive participants. As we discuss later, these ratings are not without severe limitations: participants rely on a summary of the study, their estimates of psychological moderators often diverge (i.e., are unreliable), and there may be both methodological and theoretical reasons to expect their ratings to have little-to-no predictive validity. We view this as an empirical question -- one that further illustrates the field's current ability to explain demand effects.
...
In total, there were `r vig.n` vignettes. We did not create vignettes for control conditions because participants were not given information about the experimenter's hypothesis. Because there were no explicit demand characteristics to act upon, we left motivation, belief, and opportunity values blank for this condition. @rosnow1997people
...
Sample size was based on availability of resources. We initially collected as much data as possible in a single semester from undergraduates from (anonymous for peer review). After a reviewer raised [valid] concerns about the reliability of these ratings, we collected additional ratings from Prolific workers. This was done to exploit the Law of Large Numbers: with a larger sample, relatively imprecise ratings should converge into relatively precise 
estimates of the mean levels of @rosnow1997people's moderators.
