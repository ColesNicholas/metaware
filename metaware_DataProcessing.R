## ----setup and load packages, include = F---------------------------------------------------------------------
# load libraries
library("tidyverse")
library("readxl")
library("performance")
...
## ----open/clean data, message = F, warning = F----------------------------------------------------------------
# import data
...
## ----inspect attention checks, eval = F-----------------------------------------------------------------------
...
## ----calculate vignette-specific summaries--------------------------------------------------------------------
surv.sum <- DF.surv %>% 
  group_by(vig) %>% 
